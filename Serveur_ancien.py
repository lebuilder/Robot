    ...
    def echange(self) -> None:
        ...
        while not fin:
            ...
            if commande == "avancer":
                ...
                '''if self.__course_autonome.get_autonome() == False:
                    tab_octets = self.__capteur.get_all()
                elif self.__course_autonome.get_autonome() == True:
